...
+make input 2 A and B
+print the sum of all the numbers located between these numbers on the screen
+print all the odd values ​​located between the given numbers